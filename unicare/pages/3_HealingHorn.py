...
### Complete this section after setting up an Amazon Bedrock agent
### TODO fill in values
agentId='TODO'
agentAliasId='TODO'
...
if __name__ == "__main__":
    ...
    st.header(":unicorn_face: :rainbow[Healing Horn]")
    ...
    container.write("""
    Hi, my name is Healing Horn, your AI healthcare agent powered by [Agents for Amazon Bedrock](%s). 
    I can retrieve medical records such as patient's status, conditions, and policy type for improved quality of care. You can ask me questions like:
    - Query patient_id 9 in bullet points
    - Show patient_id 1, 3, 10, 52 with kidney condition
    - Does patient_id 9 need a surgery?
    - How can lung cancer patients improve their quality of life?
    """)
